...
.text
.protected Cijk_Ailk_Bjlk_F8F8S_BH_BiasH_AmaxD_SAB_SCD_SAV_UserArgs_MT16x16x32_MI16x16x1_SN_GRVWB2_K1_MIWT1_1
.globl Cijk_Ailk_Bjlk_F8F8S_BH_BiasH_AmaxD_SAB_SCD_SAV_UserArgs_MT16x16x32_MI16x16x1_SN_GRVWB2_K1_MIWT1_1
.p2align 8
.type Cijk_Ailk_Bjlk_F8F8S_BH_BiasH_AmaxD_SAB_SCD_SAV_UserArgs_MT16x16x32_MI16x16x1_SN_GRVWB2_K1_MIWT1_1,@function
.section .rodata,#alloc
.p2align 6
.amdhsa_kernel Cijk_Ailk_Bjlk_F8F8S_BH_BiasH_AmaxD_SAB_SCD_SAV_UserArgs_MT16x16x32_MI16x16x1_SN_GRVWB2_K1_MIWT1_1
...
amdhsa.version:
  ...
  - 1
amdhsa.kernels:
  - .name: Cijk_Ailk_Bjlk_F8F8S_BH_BiasH_AmaxD_SAB_SCD_SAV_UserArgs_MT16x16x32_MI16x16x1_SN_GRVWB2_K1_MIWT1_1
    .symbol: 'Cijk_Ailk_Bjlk_F8F8S_BH_BiasH_AmaxD_SAB_SCD_SAV_UserArgs_MT16x16x32_MI16x16x1_SN_GRVWB2_K1_MIWT1_1.kd'
    .language:                   OpenCL C
    .language_version:
      - 2
      - 0
...
...
.end_amdgpu_metadata
Cijk_Ailk_Bjlk_F8F8S_BH_BiasH_AmaxD_SAB_SCD_SAV_UserArgs_MT16x16x32_MI16x16x1_SN_GRVWB2_K1_MIWT1_1:
...
v_lshrrev_b32 v3, 3, v5                            // v3 = v5 / 8
v_and_b32 v2, 7, v5                                // v2 = v5 % 8
v_readfirstlane_b32 s49, v[vgprSerial]             // WaveIdxWavefrontWidth
s_lshr_b32 s49, s49, 0x6                           // WaveId
s_mul_i32 s49, s49, 32                             // Each wave loads continuous lsp(8)*nrp(4) columns
...
v_add_co_u32 v10, vcc, 8, v9                       // groBL_1 + LSPB
v_add_co_u32 v11, vcc, 8, v10                      // groBL_2 + LSPB
v_add_co_u32 v12, vcc, 8, v11                      // groBL_3 + LSPB
...
v_mov_b32 v13, s66                                 // edge vgpr = Size0I- WG*MT - margin(8)
v_min_i32 v6, v13, v6                              // offset = (offset < edge) ? offset(v6) : edge(v13)

/* global read addresses: shift b */
s_mul_i32 s66, s[sgprWorkGroup1], 16               // WorkGroup[01] * MT
s_sub_u32 s66, s[sgprSizeJ], s66                   // edge = Size1J - WG*MT
s_sub_u32 s66, s66, 2                              // edge -= margin(2)
v_mov_b32 v13, s66                                 // edge vgpr = Size1J- WG*MT - margin(2)
...
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+0,  7,  9, 13 // gROB_0_0_0_0
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+1,  7, 10, 13 // gROB_0_0_1_0
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+2,  7, 11, 13 // gROB_0_0_2_0
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+3,  7, 12, 13 // gROB_0_0_3_0
...
buffer_load_short_d16 v[vgprG2LB+0], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], 0 offen offset:0 // G -> Reg 0_0_0_0
buffer_load_short_d16 v[vgprG2LB+2], v[vgprGlobalReadOffsetB+1], s[sgprSrdB:sgprSrdB+3], 0 offen offset:0 // G -> Reg 0_0_1_0
buffer_load_short_d16 v[vgprG2LB+1], v[vgprGlobalReadOffsetB+2], s[sgprSrdB:sgprSrdB+3], 0 offen offset:0 // G -> Reg 0_0_2_0
buffer_load_short_d16 v[vgprG2LB+3], v[vgprGlobalReadOffsetB+3], s[sgprSrdB:sgprSrdB+3], 0 offen offset:0 // G -> Reg 0_0_3_0
...
s_cbranch_scc0 label_NoBranch_626Y3SC5N43J34ZU_0   // Only branch on scc1
...
label_NoBranch_626Y3SC5N43J34ZU_0:
...
/* local write b */
ds_write_b16 v[vgprLocalWriteAddrB], v[vgprG2LB+0] offset:0 // lwoB_0_0_0_0 = (0*LSCB) + (0*LSPB)(*MT1J+PAD) = 0
ds_write_b16 v[vgprLocalWriteAddrB], v[vgprG2LB+2] offset:128 // lwoB_0_0_1_0 = (0*LSCB) + (1*LSPB)(*MT1J+PAD) = 128
ds_write_b16 v[vgprLocalWriteAddrB], v[vgprG2LB+1] offset:256 // lwoB_0_0_2_0 = (0*LSCB) + (2*LSPB)(*MT1J+PAD) = 256
ds_write_b16 v[vgprLocalWriteAddrB], v[vgprG2LB+3] offset:384 // lwoB_0_0_3_0 = (0*LSCB) + (3*LSPB)(*MT1J+PAD) = 384
...
/* g2l=0, load component 0 */
buffer_load_ubyte_d16 v[vgprG2LB+0+2], v[vgprGlobalReadOffsetB+1], s[sgprSrdB:sgprSrdB+3], 0 offen offset:0 // load one buffer value
/* g2l=0, load component 1 */
buffer_load_ubyte_d16 v0, v[vgprGlobalReadOffsetB+1], s[sgprSrdB:sgprSrdB+3], 0 offen offset:1 // load one buffer value
s_waitcnt vmcnt(0)
v_lshlrev_b32 v0, 0x8, v0                          // shift left to higher 8 bits
v_or_b32 v[vgprG2LB+0+2], v[vgprG2LB+0+2], v0      // pack a sub 8-bit with dest
/* g2l=1, load component 0 */
buffer_load_ubyte_d16 v[vgprG2LB+1+0], v[vgprGlobalReadOffsetB+2], s[sgprSrdB:sgprSrdB+3], 0 offen offset:0 // load one buffer value
/* g2l=1, load component 1 */
buffer_load_ubyte_d16 v0, v[vgprGlobalReadOffsetB+2], s[sgprSrdB:sgprSrdB+3], 0 offen offset:1 // load one buffer value
s_waitcnt vmcnt(0)
v_lshlrev_b32 v0, 0x8, v0                          // shift left to higher 8 bits
v_or_b32 v[vgprG2LB+1+0], v[vgprG2LB+1+0], v0      // pack a sub 8-bit with dest
/* g2l=1, load component 0 */
buffer_load_ubyte_d16 v[vgprG2LB+1+2], v[vgprGlobalReadOffsetB+3], s[sgprSrdB:sgprSrdB+3], 0 offen offset:0 // load one buffer value
/* g2l=1, load component 1 */
buffer_load_ubyte_d16 v0, v[vgprGlobalReadOffsetB+3], s[sgprSrdB:sgprSrdB+3], 0 offen offset:1 // load one buffer value
s_waitcnt vmcnt(0)
v_lshlrev_b32 v0, 0x8, v0                          // shift left to higher 8 bits
v_or_b32 v[vgprG2LB+1+2], v[vgprG2LB+1+2], v0      // pack a sub 8-bit with dest
...
/* Tail: add address/G2L vgpr [17...32) to pool */
...
/* Tail: remove address/G2L [17...32) from pool */
label_Summation_End_XU9FEV87X71XN3ZK_0:
...
v_cmp_eq_u32 vcc, v7, 0x1                          // wgMT%VW == 1
s_cbranch_vccnz label_ShiftVectorComponents1_GLVW1_0 // branch to shift d1 r=1
s_branch label_ShiftVectorComponents1_GLVW0_0      // no shifting

/******************************************/
/* shift d1 r=1                           */
/******************************************/
label_ShiftVectorComponents1_GLVW1_0:
v_cmp_eq_u32 vcc, v4, 0x0
s_cbranch_vccnz label_ShiftVectorComponents1_GLVW1_BM0_0 // branch to shift d1 r1 mb0

/******************************************/
/* shift d1 r=1 mb=0                      */
/******************************************/
label_ShiftVectorComponents1_GLVW1_BM0_0:  /// r1 mb0
v_cmp_eq_u32 vcc, v5, 0x0
s_cbranch_vccnz label_ShiftVectorComponents1_GLVW1_BM0_VW0_0 // branch to shift d1 r1 mb0 vw0
v_cmp_eq_u32 vcc, v5, 0x1
s_cbranch_vccnz label_ShiftVectorComponents1_GLVW1_BM0_VW1_0 // branch to shift d1 r1 mb0 vw1

/******************************************/
/* shift d1 r=1 mb=0 vw0                  */
/******************************************/
label_ShiftVectorComponents1_GLVW1_BM0_VW0_0:  /// r1 mb0 vw0
s_mov_b32 s62, 0
v_cmpx_eq_u32 s[62:63], v6, s62                    // is thread in edge glvw region
v_and_b32 v0, 63, v[vgprSerial]                    // permute register between threads
v_lshlrev_b32 v0, 2, v0                            // permute register between threads
...
s_mov_b64 s[62:63], 0xFFFFFFFFFFFFFFFF             // to restore all threads active
s_or_saveexec_b64 vcc, s[62:63]                    // all threads active
s_branch label_ShiftVectorComponents1_GLVW0_0      // done shifting


/******************************************/
/* shift d1 r=1 mb=0 vw1                  */
/******************************************/
label_ShiftVectorComponents1_GLVW1_BM0_VW1_0:  /// r1 mb0 vw1
s_mov_b32 s62, 1
v_cmpx_eq_u32 s[62:63], v6, s62                    // is thread in edge glvw region
v_and_b32 v0, 63, v[vgprSerial]                    // permute register between threads
v_lshlrev_b32 v0, 2, v0                            // permute register between threads
...
label_ShiftVectorComponents1_GLVW0_0:  /// end shift0
...
/* edge=0, allocate 2 sgpr. perBatchTmpS=2 perBatchMaskS=0 perElementMaskS=0 elementsPerBatch=9 */
/* optSingleColVgpr=1 optSharedColVgpr=0 optSGPRUsage=BufferLoad_Mask optSrdIncForRow=1 factorDim=0 */
...
v_add_lshl_u32 v10, v3, v0, 0x0                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v10, v35, v10, s[66:67]              // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,1,0,0) */
v_add_co_u32 v1, vcc, v1, 1                        // coord1.1: coord1Vgpr += d1*sg1*VW + vc1
...
v_cndmask_b32 v17, v35, v17, s[66:67]              // LDC clip if OOB. offset
...
v_cndmask_b32 v18, v35, v18, s[66:67]              // LDBias clip if OOB. offset
...
v_cndmask_b32 v17, v35, v17, s[66:67]              // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,2,0,0) */
v_add_co_u32 v1, vcc, v1, 1                        // coord1.1: coord1Vgpr += d1*sg1*VW + vc1
...
v_cndmask_b32 v22, v35, v22, s[66:67]              // LDC clip if OOB. offset
...
v_cndmask_b32 v23, v35, v23, s[66:67]              // LDBias clip if OOB. offset
...
v_cndmask_b32 v22, v35, v22, s[66:67]              // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,3,0,0) */
v_add_co_u32 v1, vcc, v1, 1                        // coord1.1: coord1Vgpr += d1*sg1*VW + vc1
...
v_cndmask_b32 v27, v35, v27, s[66:67]              // LDC clip if OOB. offset
...
v_cndmask_b32 v28, v35, v28, s[66:67]              // LDBias clip if OOB. offset
...
v_cndmask_b32 v27, v35, v27, s[66:67]              // LDD clip if OOB. offset
v_accvgpr_read_b32 v[vgprValuC+16], acc0           // copy acc to vreg[0]
