...
.text
.protected Cijk_Ailk_Bjlk_F8F8S_BH_BiasH_AmaxD_SAB_SCD_SAV_UserArgs_MT16x16x32_MI16x16x1_SN_GRVWB1_K1_MIWT1_1
.globl Cijk_Ailk_Bjlk_F8F8S_BH_BiasH_AmaxD_SAB_SCD_SAV_UserArgs_MT16x16x32_MI16x16x1_SN_GRVWB1_K1_MIWT1_1
.p2align 8
.type Cijk_Ailk_Bjlk_F8F8S_BH_BiasH_AmaxD_SAB_SCD_SAV_UserArgs_MT16x16x32_MI16x16x1_SN_GRVWB1_K1_MIWT1_1,@function
.section .rodata,#alloc
.p2align 6
.amdhsa_kernel Cijk_Ailk_Bjlk_F8F8S_BH_BiasH_AmaxD_SAB_SCD_SAV_UserArgs_MT16x16x32_MI16x16x1_SN_GRVWB1_K1_MIWT1_1
  .amdhsa_user_sgpr_kernarg_segment_ptr 1
  .amdhsa_accum_offset 64 // accvgpr offset
  .amdhsa_next_free_vgpr 68 // vgprs
  .amdhsa_next_free_sgpr 86 // sgprs
  .amdhsa_group_segment_fixed_size 2080 // lds bytes
...
amdhsa.version:
  ...
  - 1
amdhsa.kernels:
  - .name: Cijk_Ailk_Bjlk_F8F8S_BH_BiasH_AmaxD_SAB_SCD_SAV_UserArgs_MT16x16x32_MI16x16x1_SN_GRVWB1_K1_MIWT1_1
    .symbol: 'Cijk_Ailk_Bjlk_F8F8S_BH_BiasH_AmaxD_SAB_SCD_SAV_UserArgs_MT16x16x32_MI16x16x1_SN_GRVWB1_K1_MIWT1_1.kd'
    .language:                   OpenCL C
    .language_version:
      - 2
      - 0
...
...
.end_amdgpu_metadata
Cijk_Ailk_Bjlk_F8F8S_BH_BiasH_AmaxD_SAB_SCD_SAV_UserArgs_MT16x16x32_MI16x16x1_SN_GRVWB1_K1_MIWT1_1:
...
.set vgprValuB_X0_I0_D1, 10
.set vgprValuB_X0_I0_D2, 12
.set vgprValuB_X0_I0_D3, 14
...
.set vgprG2LB, 30
.set vgprPackTemp, 16
.set vgprLocalReadAddrA, 46
.set vgprLocalReadAddrB, 47
.set vgprAmaxOut, 48
.set vgprAmaxOutB, 49
.set vgprSerial, 50
...
.macro GLOBAL_OFFSET_B vgprAddr:req vgprOffset1J:req vgprOffsetL:req vgprTmp:req
    ...
    v_add_u32 v[\vgprAddr+0] 0x1 v[\vgprAddr+0]      // add prepad for pointer shift
                                                       // offset *= bytes/element (multiplier is 1 do nothing)
.endm
...
s_mov_b32 m0, 0x820                                // LDS clamp at 2080 bytes
v_mov_b32 v[vgprSerial], v0                        // thread serial id
s_cmp_eq_u32 s48, 0
s_cbranch_scc0 label_MultiGemm
/* init: add vgpr [0...17) to pool */
...
v_lshrrev_b32 v3, 4, v5                            // v3 = v5 / 16
v_and_b32 v2, 15, v5                               // v2 = v5 % 16
v_readfirstlane_b32 s49, v[vgprSerial]             // WaveIdxWavefrontWidth
s_lshr_b32 s49, s49, 0x6                           // WaveId
s_mul_i32 s49, s49, 32                             // Each wave loads continuous lsp(4)*nrp(8) columns
v_add_u32 v3, s49, v3                              // Add back to column index
...
v_add_u32 v[vgprLocalWriteAddrB], v2, v[vgprLocalWriteAddrB] // lwFOB = (lwBB + lwBL*(MT1J+PAD))*bpeDS(1)
...
v_add_co_u32 v10, vcc, 4, v9                       // groBL_1 + LSPB
v_add_co_u32 v11, vcc, 4, v10                      // groBL_2 + LSPB
v_add_co_u32 v12, vcc, 4, v11                      // groBL_3 + LSPB
v_add_co_u32 v13, vcc, 4, v12                      // groBL_4 + LSPB
v_add_co_u32 v14, vcc, 4, v13                      // groBL_5 + LSPB
v_add_co_u32 v15, vcc, 4, v14                      // groBL_6 + LSPB
v_add_co_u32 v16, vcc, 4, v15                      // groBL_7 + LSPB

/* global read addresses: shift a */
s_mul_i32 s66, s[sgprWorkGroup0], 16               // WorkGroup[01] * MT
s_sub_u32 s66, s[sgprSizeI], s66                   // edge = Size0I - WG*MT
s_sub_u32 s66, s66, 8                              // edge -= margin(8)
v_mov_b32 v51, s66                                 // edge vgpr = Size0I- WG*MT - margin(8)
v_min_i32 v6, v51, v6                              // offset = (offset < edge) ? offset(v6) : edge(v51)

/* global read addresses: final offsets a */
GLOBAL_OFFSET_A vgprGlobalReadOffsetA+0,  6,  8, 51 // gROA_0_0_0_0

/* global read addresses: final offsets b */
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+0,  7,  9, 51 // gROB_0_0_0_0
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+1,  7, 10, 51 // gROB_0_0_1_0
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+2,  7, 11, 51 // gROB_0_0_2_0
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+3,  7, 12, 51 // gROB_0_0_3_0
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+4,  7, 13, 51 // gROB_0_0_4_0
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+5,  7, 14, 51 // gROB_0_0_5_0
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+6,  7, 15, 51 // gROB_0_0_6_0
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+7,  7, 16, 51 // gROB_0_0_7_0
...
s_mul_hi_u32 s67, 32, s[sgprGSUSumIdx]             // gsuOffset = DepthU*GSUSumIdx
s_mul_i32 s66, 32, s[sgprGSUSumIdx]                // gsuOffset = DepthU*GSUSumIdx
s_mul_hi_u32 s67, s66, s[sgprStrideBL]             // tlu=1, scaled unroll-offset by stride
s_mul_i32 s66, s66, s[sgprStrideBL]                // tlu=1, scaled unroll-offset by stride
s_add_u32 s68, s68, s66                            // accum GsuOffset term to tilestart
s_addc_u32 s69, s69, s67                           // accum GsuOffset term to tilestart
...
s_mul_hi_u32 s67, constStrideB1J, s66              // stride x (size-1)
s_mul_i32 s66, constStrideB1J, s66                 // stride x (size-1)
...
s_sub_u32 s66, s[sgprSizeL], 1                     // (size-1)
s_mul_hi_u32 s67, s[sgprStrideBL], s66             // stride x (size-1)
s_mul_i32 s66, s[sgprStrideBL], s66                // stride x (size-1)
s_add_u32 s[sgprShadowLimitB+0], s[sgprShadowLimitB+0], s66 // sum tensor size
s_addc_u32 s[sgprShadowLimitB+1], s[sgprShadowLimitB+1], s67 // sum tensor size
...
s_mul_i32 s66, s[sgprGSU], DepthU*BpeAGR
s_mul_i32 s[sgprGlobalReadIncsA+0], s66, s[sgprStrideAL] // incrA unrollIdx)

/* global read addresses: increments b */
s_mul_i32 s66, s[sgprGSU], DepthU*BpeBGR
s_mul_i32 s[sgprGlobalReadIncsB+0], s66, s[sgprStrideBL] // incrB unrollIdx)
...
buffer_load_ubyte_d16 v[vgprG2LB+0], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], 0 offen offset:0 // G -> Reg 0_0_0_0
buffer_load_ubyte_d16 v[vgprG2LB+4], v[vgprGlobalReadOffsetB+1], s[sgprSrdB:sgprSrdB+3], 0 offen offset:0 // G -> Reg 0_0_1_0
buffer_load_ubyte_d16 v[vgprG2LB+8], v[vgprGlobalReadOffsetB+2], s[sgprSrdB:sgprSrdB+3], 0 offen offset:0 // G -> Reg 0_0_2_0
buffer_load_ubyte_d16 v[vgprG2LB+12], v[vgprGlobalReadOffsetB+3], s[sgprSrdB:sgprSrdB+3], 0 offen offset:0 // G -> Reg 0_0_3_0
buffer_load_ubyte_d16 v[vgprG2LB+1], v[vgprGlobalReadOffsetB+4], s[sgprSrdB:sgprSrdB+3], 0 offen offset:0 // G -> Reg 0_0_4_0
buffer_load_ubyte_d16 v[vgprG2LB+5], v[vgprGlobalReadOffsetB+5], s[sgprSrdB:sgprSrdB+3], 0 offen offset:0 // G -> Reg 0_0_5_0
buffer_load_ubyte_d16 v[vgprG2LB+9], v[vgprGlobalReadOffsetB+6], s[sgprSrdB:sgprSrdB+3], 0 offen offset:0 // G -> Reg 0_0_6_0
buffer_load_ubyte_d16 v[vgprG2LB+13], v[vgprGlobalReadOffsetB+7], s[sgprSrdB:sgprSrdB+3], 0 offen offset:0 // G -> Reg 0_0_7_0
...
/* initC: remove ValuA/B vgpr buffer [0...17) from pool */
...
s_cbranch_scc0 label_NoBranch_VCWPMOGT6S6AAV2Z_0   // Only branch on scc1
...
label_NoBranch_VCWPMOGT6S6AAV2Z_0:
...
/* local write b */
ds_write_b8 v[vgprLocalWriteAddrB], v[vgprG2LB+0] offset:0 // lwoB_0_0_0_0 = (0*LSCB) + (0*LSPB)(*MT1J+PAD) = 0
ds_write_b8 v[vgprLocalWriteAddrB], v[vgprG2LB+4] offset:64 // lwoB_0_0_1_0 = (0*LSCB) + (1*LSPB)(*MT1J+PAD) = 64
ds_write_b8 v[vgprLocalWriteAddrB], v[vgprG2LB+8] offset:128 // lwoB_0_0_2_0 = (0*LSCB) + (2*LSPB)(*MT1J+PAD) = 128
ds_write_b8 v[vgprLocalWriteAddrB], v[vgprG2LB+12] offset:192 // lwoB_0_0_3_0 = (0*LSCB) + (3*LSPB)(*MT1J+PAD) = 192
ds_write_b8 v[vgprLocalWriteAddrB], v[vgprG2LB+1] offset:256 // lwoB_0_0_4_0 = (0*LSCB) + (4*LSPB)(*MT1J+PAD) = 256
ds_write_b8 v[vgprLocalWriteAddrB], v[vgprG2LB+5] offset:320 // lwoB_0_0_5_0 = (0*LSCB) + (5*LSPB)(*MT1J+PAD) = 320
ds_write_b8 v[vgprLocalWriteAddrB], v[vgprG2LB+9] offset:384 // lwoB_0_0_6_0 = (0*LSCB) + (6*LSPB)(*MT1J+PAD) = 384
ds_write_b8 v[vgprLocalWriteAddrB], v[vgprG2LB+13] offset:448 // lwoB_0_0_7_0 = (0*LSCB) + (7*LSPB)(*MT1J+PAD) = 448
...
ds_read_u8 v[vgprValuB_X0_I0+0], v[vgprLocalReadAddrB] offset:0 // L -> Reg lro=0 swapByteOffset=0 ti=16 vIdx=0 eIdx=0 rIdx=0 oIdx=0 buffer=0 iui=0
ds_read_u8 v[vgprValuB_X0_I0_D1+0], v[vgprLocalReadAddrB] offset:16 // L -> Reg lro=0 swapByteOffset=0 ti=16 vIdx=0 eIdx=0 rIdx=1 oIdx=0 buffer=0 iui=0
ds_read_u8_d16_hi v[vgprValuB_X0_I0_D2+0], v[vgprLocalReadAddrB] offset:32 // L -> Reg lro=0 swapByteOffset=0 ti=16 vIdx=0 eIdx=0 rIdx=2 oIdx=0 buffer=0 iui=0
ds_read_u8_d16_hi v[vgprValuB_X0_I0_D3+0], v[vgprLocalReadAddrB] offset:48 // L -> Reg lro=0 swapByteOffset=0 ti=16 vIdx=0 eIdx=0 rIdx=3 oIdx=0 buffer=0 iui=0
ds_read_u8 v[vgprValuB_X0_I0+1], v[vgprLocalReadAddrB] offset:64 // L -> Reg lro=0 swapByteOffset=0 ti=16 vIdx=0 eIdx=0 rIdx=4 oIdx=0 buffer=0 iui=0
ds_read_u8 v[vgprValuB_X0_I0_D1+1], v[vgprLocalReadAddrB] offset:80 // L -> Reg lro=0 swapByteOffset=0 ti=16 vIdx=0 eIdx=0 rIdx=5 oIdx=0 buffer=0 iui=0
ds_read_u8_d16_hi v[vgprValuB_X0_I0_D2+1], v[vgprLocalReadAddrB] offset:96 // L -> Reg lro=0 swapByteOffset=0 ti=16 vIdx=0 eIdx=0 rIdx=6 oIdx=0 buffer=0 iui=0
ds_read_u8_d16_hi v[vgprValuB_X0_I0_D3+1], v[vgprLocalReadAddrB] offset:112 // L -> Reg lro=0 swapByteOffset=0 ti=16 vIdx=0 eIdx=0 rIdx=7 oIdx=0 buffer=0 iui=0
...
v_or_b32 v[vgprValuB_X0_I0+0], v[vgprValuB_X0_I0+0], v[vgprValuB_X0_I0_D2+0] // pack two half Vgpr to one Vgpr
...
v_or_b32 v[vgprValuB_X0_I0+1], v[vgprValuB_X0_I0+1], v[vgprValuB_X0_I0_D2+1] // pack two half Vgpr to one Vgpr
...
/* Tail: add ValuA/B vgpr buffer [0...17) to pool */
...
/* g2l=0, load component 0 */
buffer_load_ubyte_d16 v[vgprG2LB+0+4], v[vgprGlobalReadOffsetB+1], s[sgprSrdB:sgprSrdB+3], 0 offen offset:0 // load one buffer value
/* g2l=0, load component 0 */
buffer_load_ubyte_d16 v[vgprG2LB+0+8], v[vgprGlobalReadOffsetB+2], s[sgprSrdB:sgprSrdB+3], 0 offen offset:0 // load one buffer value
/* g2l=0, load component 0 */
buffer_load_ubyte_d16 v[vgprG2LB+0+12], v[vgprGlobalReadOffsetB+3], s[sgprSrdB:sgprSrdB+3], 0 offen offset:0 // load one buffer value
/* g2l=1, load component 0 */
buffer_load_ubyte_d16 v[vgprG2LB+1+0], v[vgprGlobalReadOffsetB+4], s[sgprSrdB:sgprSrdB+3], 0 offen offset:0 // load one buffer value
/* g2l=1, load component 0 */
buffer_load_ubyte_d16 v[vgprG2LB+1+4], v[vgprGlobalReadOffsetB+5], s[sgprSrdB:sgprSrdB+3], 0 offen offset:0 // load one buffer value
/* g2l=1, load component 0 */
buffer_load_ubyte_d16 v[vgprG2LB+1+8], v[vgprGlobalReadOffsetB+6], s[sgprSrdB:sgprSrdB+3], 0 offen offset:0 // load one buffer value
/* g2l=1, load component 0 */
buffer_load_ubyte_d16 v[vgprG2LB+1+12], v[vgprGlobalReadOffsetB+7], s[sgprSrdB:sgprSrdB+3], 0 offen offset:0 // load one buffer value
...
/* Tail: remove ValuA/B vgpr buffer [0...17) from pool */

/* Tail: add address/G2L vgpr [17...48) to pool */
...
/* local read inc a */
s_mov_b32 s8, 0x200                                // inc
v_add_co_u32 v[vgprLocalReadAddrA], vcc, s8, v[vgprLocalReadAddrA] // lrA += 512 ((MT+PAD)*bpeDS)

/* local read inc b */
                                                   // inc (dup assign opt.)
v_add_co_u32 v[vgprLocalReadAddrB], vcc, s8, v[vgprLocalReadAddrB] // lrB += 512 ((MT+PAD)*bpeDS)
...
v_lshl_or_b32 v[vgprValuB_X0_I0_D2+1], v[vgprValuB_X0_I0_D3+1], 8, v[vgprValuB_X0_I0_D2+1] // pack two int8 Vgpr to one half Vgpr
v_or_b32 v[vgprValuB_X0_I0+1], v[vgprValuB_X0_I0+1], v[vgprValuB_X0_I0_D2+1] // pack two half Vgpr to one Vgpr
v_and_b32 v17, 63, v[vgprSerial]                   // v17 = v[vgprSerial] % 64
v_lshrrev_b32 v17, 4, v17                          // v17 = v17 / 16
v_lshlrev_b32 v17, 0x3, v17                        // v17 = v17 * 8
v_cmp_ge_i32 s[66:67], v17, s[sgprLoopCounterL]    // check K index >= Size L
...
v_sub_u32 v17, s[sgprLoopCounterL], v17            // get distance between size and k index
v_cmp_lt_i32 s[66:67], v17, 8                      // set partial 0 if distance less than input per thread
...
v_lshlrev_b64 v[18:19], s68, v[vgprValuA_X0_I0+0+0+0:vgprValuA_X0_I0+0+0+0+1]
v_cndmask_b32 v[vgprValuA_X0_I0+0+0+0+0], v[vgprValuA_X0_I0+0+0+0+0], v18, s[66:67]
v_cndmask_b32 v[vgprValuA_X0_I0+0+0+0+1], v[vgprValuA_X0_I0+0+0+0+1], v19, s[66:67]
v_lshlrev_b64 v[18:19], s68, v[vgprValuB_X0_I0+0+0+0:vgprValuB_X0_I0+0+0+0+1]
v_cndmask_b32 v[vgprValuB_X0_I0+0+0+0+0], v[vgprValuB_X0_I0+0+0+0+0], v18, s[66:67]
v_cndmask_b32 v[vgprValuB_X0_I0+0+0+0+1], v[vgprValuB_X0_I0+0+0+0+1], v19, s[66:67]
s_nop 1
v_mfma_f32_16x16x32_fp8_fp8 acc[0:3], v[vgprValuB_X0_I0+0+0+0:vgprValuB_X0_I0+0+0+0+1], v[vgprValuA_X0_I0+0+0+0:vgprValuA_X0_I0+0+0+0+1], acc[0:3] // left value = acc[0+0:3+0]
...
/* Tail: remove address/G2L [17...48) from pool */
label_Summation_End_JBQDG79IR3A5AZJH_0:
...
s_load_dwordx8 s[48:55], s[sgprKernArgAddress:sgprKernArgAddress+1], 0x70
s_load_dwordx4 s[56:59], s[sgprKernArgAddress:sgprKernArgAddress+1], 0x90
s_load_dwordx2 s[60:61], s[sgprKernArgAddress:sgprKernArgAddress+1], 0xa0
...
v_cmp_lt_u32 s[62:63], v3, v4                      // wgMT < MT
v_cndmask_b32 v3, v4, v3, s[62:63]                 // wgMT = (wgMT < MT) ? wgMT : MT
...
v_cmp_eq_u32 s[62:63], v6, v5                      // wave_id == block_belong_to_wave?
v_cndmask_b32 v3, v4, v3, s[62:63]                 // wgMT = (wgMT < MT) ? wgMT : MT
...
s_mov_b32 s62, 0
v_cmpx_eq_u32 s[62:63], v6, s62                    // is thread in edge glvw region
...
s_mov_b64 s[62:63], 0xFFFFFFFFFFFFFFFF             // to restore all threads active
s_or_saveexec_b64 vcc, s[62:63]                    // all threads active
...
s_waitcnt lgkmcnt(0)                               // wait for 56 bytes of kern args.
s_cmp_eq_u32 s[sgprGSU], 1                         // GSU == 1 ?
s_cbranch_scc1 label_GSU_5                         // branch if GSU == 1
s_and_b32 s62, 15, s[sgprSizeI]                    // s62 = s[sgprSizeI] % 16
...
v_cndmask_b32 v10, v18, v10, s[66:67]              // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,1,0,0) */
...
v_cndmask_b32 v12, v18, v12, s[66:67]              // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,2,0,0) */
v_add_co_u32 v1, vcc, v1, 1                        // coord1.1: coord1Vgpr += d1*sg1*VW + vc1
...
v_cndmask_b32 v14, v18, v14, s[66:67]              // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,3,0,0) */
v_add_co_u32 v1, vcc, v1, 1                        // coord1.1: coord1Vgpr += d1*sg1*VW + vc1
...
v_cndmask_b32 v16, v18, v16, s[66:67]              // LDD clip if OOB. offset
...
s_add_i32 s64, label_KernelEnd, 0x4                // target branch offset
...
s_load_dword s47, s[sgprAddressScaleC:sgprAddressScaleC+1], 0 // load scaleC
label_ScaleCValid:
...
s_add_u32 s62, s[sgprWorkGroup2], 0x1
s_mul_i32 s62, s[sgprBiasStride], s62              // stride * (wg+1)
s_cmp_eq_u32 s62, 0x0                              // bias stride = 0?
s_cselect_b32 s62, s[sgprSizeI], s62
...
s_mul_i32 s62, 16, s[sgprWorkGroup0]               // wgp0 * MT0
v_add_u32 v8, s62, v[vgprSerial]                   // coord 0 = wgp0 * MT0 + thread offset
s_mul_i32 s62, s[sgprBiasStride], s[sgprWorkGroup2] // Stride * WG
v_add_u32 v8, s62, v8                              // coord 0 = wgp0 * MT0 + thread offset + Stride * WG
...
buffer_load_dword v15, v13, s[sgprSrdScaleAlphaVec:sgprSrdScaleAlphaVec+3], 0 offen offset:0 // load scaleAlphaVecI
/* (d1,vc1,d0,vc0)=(0,1,0,0) */
/* (d1,vc1,d0,vc0)=(0,2,0,0) */
/* (d1,vc1,d0,vc0)=(0,3,0,0) */
...
v_add_f32 v[vgprValuC+16], v14, v[vgprValuC+16]    // C += bias
v_max_f32 v[vgprAmaxOut], v[vgprAmaxOut], abs(v[vgprValuC+16]) // absmax
v_mul_f32 v[vgprValuC+16], v[vgprValuC+16], s[sgprScaleD] // result *= ScaleD
v_cmp_class_f32 s[62:63], v[vgprValuC+16], v7      // Nan and +/- inf
v_med3_f32 v6, v[vgprValuC+16], v8, v9
v_cndmask_b32 v[vgprValuC+16], v6, v[vgprValuC+16], s[62:63]
...
v_cmp_gt_u32 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], s[sgprSrdScaleAlphaVec+2], 0 //  == 0 ?
v_cndmask_b32 v15, 1.0, v15, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
v_mul_f32 v[vgprValuC+17], v15, v[vgprValuC+17]    // *= ScaleAlphaVecVMul
v_add_f32 v[vgprValuC+17], v14, v[vgprValuC+17]    // C += bias
v_max_f32 v[vgprAmaxOut], v[vgprAmaxOut], abs(v[vgprValuC+17]) // absmax
v_mul_f32 v[vgprValuC+17], v[vgprValuC+17], s[sgprScaleD] // result *= ScaleD
v_cmp_class_f32 s[62:63], v[vgprValuC+17], v7      // Nan and +/- inf
v_med3_f32 v6, v[vgprValuC+17], v8, v9
v_cndmask_b32 v[vgprValuC+17], v6, v[vgprValuC+17], s[62:63]
v_cvt_pk_fp8_f32 v17, v[vgprValuC+17], v[vgprValuC+17] op_sel:[0,0,0]
s_lshl_b32 s62, s[sgprStrideD1J], 0                // incToNextRow: Scale by BPE
s_add_u32 s[sgprSrdD+0], s[sgprSrdD+0], s62        // incToNextRow: gra SRD += inc(lower)
s_addc_u32 s[sgprSrdD+1], s[sgprSrdD+1], 0         // incToNextRow: gra SRD += inc(upper)
buffer_store_byte v17, v10, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0 // store D
v_cmp_gt_u32 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], s[sgprSrdScaleAlphaVec+2], 0 //  == 0 ?
v_cndmask_b32 v15, 1.0, v15, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
v_mul_f32 v[vgprValuC+18], v15, v[vgprValuC+18]    // *= ScaleAlphaVecVMul
v_add_f32 v[vgprValuC+18], v14, v[vgprValuC+18]    // C += bias
v_max_f32 v[vgprAmaxOut], v[vgprAmaxOut], abs(v[vgprValuC+18]) // absmax
v_mul_f32 v[vgprValuC+18], v[vgprValuC+18], s[sgprScaleD] // result *= ScaleD
v_cmp_class_f32 s[62:63], v[vgprValuC+18], v7      // Nan and +/- inf
v_med3_f32 v6, v[vgprValuC+18], v8, v9
v_cndmask_b32 v[vgprValuC+18], v6, v[vgprValuC+18], s[62:63]
v_cvt_pk_fp8_f32 v18, v[vgprValuC+18], v[vgprValuC+18] op_sel:[0,0,0]
s_lshl_b32 s62, s[sgprStrideD1J], 0                // incToNextRow: Scale by BPE
s_add_u32 s[sgprSrdD+0], s[sgprSrdD+0], s62        // incToNextRow: gra SRD += inc(lower)
s_addc_u32 s[sgprSrdD+1], s[sgprSrdD+1], 0         // incToNextRow: gra SRD += inc(upper)
buffer_store_byte v18, v10, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0 // store D
v_cmp_gt_u32 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], s[sgprSrdScaleAlphaVec+2], 0 //  == 0 ?
v_cndmask_b32 v15, 1.0, v15, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
v_mul_f32 v[vgprValuC+19], v15, v[vgprValuC+19]    // *= ScaleAlphaVecVMul
v_add_f32 v[vgprValuC+19], v14, v[vgprValuC+19]    // C += bias
v_max_f32 v[vgprAmaxOut], v[vgprAmaxOut], abs(v[vgprValuC+19]) // absmax
v_mul_f32 v[vgprValuC+19], v[vgprValuC+19], s[sgprScaleD] // result *= ScaleD
v_cmp_class_f32 s[62:63], v[vgprValuC+19], v7      // Nan and +/- inf
v_med3_f32 v6, v[vgprValuC+19], v8, v9
v_cndmask_b32 v[vgprValuC+19], v6, v[vgprValuC+19], s[62:63]
...
s_and_b64 s[66:67], s[62:63], s[66:67]             // in0 && in1
s_mul_i32 s62, 16, s[sgprWorkGroup0]               // wgp0 * MT0
v_sub_u32 v11, v0, s62
v_lshlrev_b32 v11, 0x2, v11                        // Bias address scaled by BPE
v_cndmask_b32 v11, v28, v11, s[66:67]              // LDBias clip if OOB. offset
s_waitcnt lgkmcnt(0)                               // Wait for Bias LDS write
s_barrier                                          // Bias LDS write barrier
...
v_cndmask_b32 v10, v28, v10, s[66:67]              // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,1,0,0) */
v_add_co_u32 v1, vcc, v1, 1                        // coord1.1: coord1Vgpr += d1*sg1*VW + vc1
...
s_and_b64 s[66:67], s[62:63], s[66:67]             // in0 && in1
s_mul_i32 s62, 16, s[sgprWorkGroup0]               // wgp0 * MT0
v_sub_u32 v17, v0, s62
v_lshlrev_b32 v17, 0x2, v17                        // Bias address scaled by BPE
v_cndmask_b32 v17, v28, v17, s[66:67]              // LDBias clip if OOB. offset
...
v_cndmask_b32 v16, v28, v16, s[66:67]              // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,2,0,0) */
v_add_co_u32 v1, vcc, v1, 1                        // coord1.1: coord1Vgpr += d1*sg1*VW + vc1
...
s_and_b64 s[66:67], s[62:63], s[66:67]             // in0 && in1
s_mul_i32 s62, 16, s[sgprWorkGroup0]               // wgp0 * MT0
v_sub_u32 v21, v0, s62
v_lshlrev_b32 v21, 0x2, v21                        // Bias address scaled by BPE
v_cndmask_b32 v21, v28, v21, s[66:67]              // LDBias clip if OOB. offset
...
v_cndmask_b32 v20, v28, v20, s[66:67]              // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,3,0,0) */
v_add_co_u32 v1, vcc, v1, 1                        // coord1.1: coord1Vgpr += d1*sg1*VW + vc1
...
s_and_b64 s[66:67], s[62:63], s[66:67]             // in0 && in1
s_mul_i32 s62, 16, s[sgprWorkGroup0]               // wgp0 * MT0
v_sub_u32 v25, v0, s62
v_lshlrev_b32 v25, 0x2, v25                        // Bias address scaled by BPE
v_cndmask_b32 v25, v28, v25, s[66:67]              // LDBias clip if OOB. offset
...
v_cndmask_b32 v24, v28, v24, s[66:67]              // LDD clip if OOB. offset
...
v_max_f32 v[vgprAmaxOut], v[vgprAmaxOut], abs(v[vgprValuC+15]) // absmax
v_mul_f32 v[vgprValuC+15], v[vgprValuC+15], s[sgprScaleD] // result *= ScaleD
v_cmp_class_f32 s[62:63], v[vgprValuC+15], v7      // Nan and +/- inf
v_med3_f32 v6, v[vgprValuC+15], v8, v9
v_cndmask_b32 v[vgprValuC+15], v6, v[vgprValuC+15], s[62:63]
...
v_add_f32 v[vgprValuC+19], v13, v[vgprValuC+19]    // C += bias
v_max_f32 v[vgprAmaxOut], v[vgprAmaxOut], abs(v[vgprValuC+19]) // absmax
v_mul_f32 v[vgprValuC+19], v[vgprValuC+19], s[sgprScaleD] // result *= ScaleD
v_cmp_class_f32 s[62:63], v[vgprValuC+19], v7      // Nan and +/- inf
v_med3_f32 v6, v[vgprValuC+19], v8, v9
v_cndmask_b32 v[vgprValuC+19], v6, v[vgprValuC+19], s[62:63]
v_cvt_pk_fp8_f32 v19, v[vgprValuC+19], v[vgprValuC+19] op_sel:[0,0,0]
buffer_store_byte v19, v16, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0 // store D
v_cmp_gt_u32 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], s[sgprSrdScaleAlphaVec+2], 0 //  == 0 ?
v_cndmask_b32 v14, 1.0, v14, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
v_mul_f32 v[vgprValuC+23], v14, v[vgprValuC+23]    // *= ScaleAlphaVecVMul
v_add_f32 v[vgprValuC+23], v13, v[vgprValuC+23]    // C += bias
v_max_f32 v[vgprAmaxOut], v[vgprAmaxOut], abs(v[vgprValuC+23]) // absmax
v_mul_f32 v[vgprValuC+23], v[vgprValuC+23], s[sgprScaleD] // result *= ScaleD
v_cmp_class_f32 s[62:63], v[vgprValuC+23], v7      // Nan and +/- inf
v_med3_f32 v6, v[vgprValuC+23], v8, v9
v_cndmask_b32 v[vgprValuC+23], v6, v[vgprValuC+23], s[62:63]
...
v_cmp_gt_u32 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], s[sgprSrdScaleAlphaVec+2], 0 //  == 0 ?
v_cndmask_b32 v14, 1.0, v14, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
v_mul_f32 v[vgprValuC+27], v14, v[vgprValuC+27]    // *= ScaleAlphaVecVMul
v_add_f32 v[vgprValuC+27], v13, v[vgprValuC+27]    // C += bias
v_max_f32 v[vgprAmaxOut], v[vgprAmaxOut], abs(v[vgprValuC+27]) // absmax
v_mul_f32 v[vgprValuC+27], v[vgprValuC+27], s[sgprScaleD] // result *= ScaleD
v_cmp_class_f32 s[62:63], v[vgprValuC+27], v7      // Nan and +/- inf
v_med3_f32 v6, v[vgprValuC+27], v8, v9
v_cndmask_b32 v[vgprValuC+27], v6, v[vgprValuC+27], s[62:63]
...
s_waitcnt lgkmcnt(0)                               // Wait for Bias LDS write
s_barrier                                          // Bias LDS write barrier
ds_read_b32 v15, v12 offset:0                      // load bias
v_lshlrev_b32 v13, 0x2, v0                         // ScaleAlphaVec address scaled by BPE
buffer_load_dword v16, v13, s[sgprSrdScaleAlphaVec:sgprSrdScaleAlphaVec+3], 0 offen offset:0 // load scaleAlphaVecI
/* (d1,vc1,d0,vc0)=(0,1,0,0) */
s_lshl_b32 s62, s[sgprStrideC1J], 0                // incToNextRow: Scale by BPE
...
s_add_u32 s[sgprSrdC+0], s[sgprSrdC+0], s62        // incToNextRow: gra SRD += inc(lower)
s_addc_u32 s[sgprSrdC+1], s[sgprSrdC+1], 0         // incToNextRow: gra SRD += inc(upper)
buffer_load_ubyte_d16 v22, v11, s[sgprSrdC:sgprSrdC+3], 0 offen offset:0 // load C
v_add_lshl_u32 v10, v3, v0, 0x0                    // optSingleColVgpr scaleToBpe: sharedAddrVgpr <- cinRowPtr + coord0, scaled by BPE. BSHERE:coord0=0, coord0Vgpr=0
v_accvgpr_read_b32 v[vgprValuC+17], acc0           // copy acc to vreg[0]
v_accvgpr_read_b32 v[vgprValuC+19], acc1           // copy acc to vreg[1]
v_accvgpr_read_b32 v[vgprValuC+21], acc2           // copy acc to vreg[2]
...
v_cmp_gt_u32 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], s[sgprSrdScaleAlphaVec+2], 0 //  == 0 ?
v_cndmask_b32 v16, 1.0, v16, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
v_mul_f32 v[vgprValuC+19], v16, v[vgprValuC+19]    // *= ScaleAlphaVecVMul
v_cvt_f32_fp8 v4, v18 src0_sel:BYTE_0
s_nop 0
v_fmac_f32 v[vgprValuC+19], v4, s[sgprBeta]        // finalSum = sum*alpha + C*beta
v_add_f32 v[vgprValuC+19], v15, v[vgprValuC+19]    // C += bias
v_max_f32 v[vgprAmaxOut], v[vgprAmaxOut], abs(v[vgprValuC+19]) // absmax
v_mul_f32 v[vgprValuC+19], v[vgprValuC+19], s[sgprScaleD] // result *= ScaleD
v_cmp_class_f32 s[62:63], v[vgprValuC+19], v7      // Nan and +/- inf
v_med3_f32 v6, v[vgprValuC+19], v8, v9
...
v_cmp_gt_u32 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], s[sgprSrdScaleAlphaVec+2], 0 //  == 0 ?
v_cndmask_b32 v16, 1.0, v16, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
v_mul_f32 v[vgprValuC+21], v16, v[vgprValuC+21]    // *= ScaleAlphaVecVMul
v_cvt_f32_fp8 v4, v20 src0_sel:BYTE_0
s_nop 0
v_fmac_f32 v[vgprValuC+21], v4, s[sgprBeta]        // finalSum = sum*alpha + C*beta
v_add_f32 v[vgprValuC+21], v15, v[vgprValuC+21]    // C += bias
v_max_f32 v[vgprAmaxOut], v[vgprAmaxOut], abs(v[vgprValuC+21]) // absmax
v_mul_f32 v[vgprValuC+21], v[vgprValuC+21], s[sgprScaleD] // result *= ScaleD
v_cmp_class_f32 s[62:63], v[vgprValuC+21], v7      // Nan and +/- inf
v_med3_f32 v6, v[vgprValuC+21], v8, v9
v_cndmask_b32 v[vgprValuC+21], v6, v[vgprValuC+21], s[62:63]
...
v_cmp_gt_u32 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], s[sgprSrdScaleAlphaVec+2], 0 //  == 0 ?
v_cndmask_b32 v16, 1.0, v16, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
v_mul_f32 v[vgprValuC+23], v16, v[vgprValuC+23]    // *= ScaleAlphaVecVMul
v_cvt_f32_fp8 v4, v22 src0_sel:BYTE_0
s_nop 0
v_fmac_f32 v[vgprValuC+23], v4, s[sgprBeta]        // finalSum = sum*alpha + C*beta
v_add_f32 v[vgprValuC+23], v15, v[vgprValuC+23]    // C += bias
v_max_f32 v[vgprAmaxOut], v[vgprAmaxOut], abs(v[vgprValuC+23]) // absmax
v_mul_f32 v[vgprValuC+23], v[vgprValuC+23], s[sgprScaleD] // result *= ScaleD
v_cmp_class_f32 s[62:63], v[vgprValuC+23], v7      // Nan and +/- inf
v_med3_f32 v6, v[vgprValuC+23], v8, v9
...
s_add_u32 s[sgprSrdD+0], s[sgprSrdD+0], s62        // incToNextRow: gra SRD += inc(lower)
s_addc_u32 s[sgprSrdD+1], s[sgprSrdD+1], 0         // incToNextRow: gra SRD += inc(upper)
buffer_store_byte v23, v10, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0 // store D
s_nop 0                                            // 1 wait state required when next inst writes vgprs held by previous dwordx4 store inst
s_branch label_GW_End_1                            // jump to end
label_GW_B1_E1:
...
v_cndmask_b32 v10, v32, v10, s[66:67]              // LDC clip if OOB. offset
buffer_load_ubyte_d16 v13, v10, s[sgprSrdC:sgprSrdC+3], 0 offen offset:0 // load C
s_mul_i32 s62, 16, s[sgprWorkGroup0]               // wgp0 * MT0
v_sub_u32 v11, v0, s62
v_lshlrev_b32 v11, 0x2, v11                        // Bias address scaled by BPE
v_cndmask_b32 v11, v32, v11, s[66:67]              // LDBias clip if OOB. offset
s_waitcnt lgkmcnt(0)                               // Wait for Bias LDS write
s_barrier                                          // Bias LDS write barrier
...
v_add_lshl_u32 v10, v3, v0, 0x0                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v10, v32, v10, s[66:67]              // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,1,0,0) */
v_add_co_u32 v1, vcc, v1, 1                        // coord1.1: coord1Vgpr += d1*sg1*VW + vc1
...
v_cmp_lt_u32 s[66:67], v1, s[sgprSizeJ]            // coord1 < size1
s_and_b64 s[66:67], s[62:63], s[66:67]             // in0 && in1
v_add_lshl_u32 v17, v2, v0, 0x0                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v17, v32, v17, s[66:67]              // LDC clip if OOB. offset
buffer_load_ubyte_d16 v20, v17, s[sgprSrdC:sgprSrdC+3], 0 offen offset:0 // load C
s_mul_i32 s62, 16, s[sgprWorkGroup0]               // wgp0 * MT0
v_sub_u32 v18, v0, s62
v_lshlrev_b32 v18, 0x2, v18                        // Bias address scaled by BPE
v_cndmask_b32 v18, v32, v18, s[66:67]              // LDBias clip if OOB. offset
...
v_cndmask_b32 v17, v32, v17, s[66:67]              // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,2,0,0) */
v_add_co_u32 v1, vcc, v1, 1                        // coord1.1: coord1Vgpr += d1*sg1*VW + vc1
...
v_cmp_lt_u32 s[66:67], v1, s[sgprSizeJ]            // coord1 < size1
s_and_b64 s[66:67], s[62:63], s[66:67]             // in0 && in1
v_add_lshl_u32 v22, v2, v0, 0x0                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v22, v32, v22, s[66:67]              // LDC clip if OOB. offset
buffer_load_ubyte_d16 v25, v22, s[sgprSrdC:sgprSrdC+3], 0 offen offset:0 // load C
s_mul_i32 s62, 16, s[sgprWorkGroup0]               // wgp0 * MT0
v_sub_u32 v23, v0, s62
v_lshlrev_b32 v23, 0x2, v23                        // Bias address scaled by BPE
v_cndmask_b32 v23, v32, v23, s[66:67]              // LDBias clip if OOB. offset
v_lshlrev_b32 v24, 0x2, v0                         // ScaleAlphaVec address scaled by BPE
v_add_lshl_u32 v22, v3, v0, 0x0                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v22, v32, v22, s[66:67]              // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,3,0,0) */
v_add_co_u32 v1, vcc, v1, 1                        // coord1.1: coord1Vgpr += d1*sg1*VW + vc1
...
v_cmp_lt_u32 s[66:67], v1, s[sgprSizeJ]            // coord1 < size1
s_and_b64 s[66:67], s[62:63], s[66:67]             // in0 && in1
v_add_lshl_u32 v27, v2, v0, 0x0                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v27, v32, v27, s[66:67]              // LDC clip if OOB. offset
buffer_load_ubyte_d16 v30, v27, s[sgprSrdC:sgprSrdC+3], 0 offen offset:0 // load C
s_mul_i32 s62, 16, s[sgprWorkGroup0]               // wgp0 * MT0
v_sub_u32 v28, v0, s62
v_lshlrev_b32 v28, 0x2, v28                        // Bias address scaled by BPE
v_cndmask_b32 v28, v32, v28, s[66:67]              // LDBias clip if OOB. offset
v_lshlrev_b32 v29, 0x2, v0                         // ScaleAlphaVec address scaled by BPE
v_add_lshl_u32 v27, v3, v0, 0x0                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v27, v32, v27, s[66:67]              // LDD clip if OOB. offset
v_accvgpr_read_b32 v[vgprValuC+16], acc0           // copy acc to vreg[0]
...
v_cmp_gt_u32 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], s[sgprSrdScaleAlphaVec+2], 0 //  == 0 ?
v_cndmask_b32 v15, 1.0, v15, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
v_mul_f32 v[vgprValuC+21], v15, v[vgprValuC+21]    // *= ScaleAlphaVecVMul
v_cvt_f32_fp8 v4, v20 src0_sel:BYTE_0
s_nop 0
v_fmac_f32 v[vgprValuC+21], v4, s[sgprBeta]        // finalSum = sum*alpha + C*beta
v_add_f32 v[vgprValuC+21], v14, v[vgprValuC+21]    // C += bias
v_max_f32 v[vgprAmaxOut], v[vgprAmaxOut], abs(v[vgprValuC+21]) // absmax
v_mul_f32 v[vgprValuC+21], v[vgprValuC+21], s[sgprScaleD] // result *= ScaleD
v_cmp_class_f32 s[62:63], v[vgprValuC+21], v7      // Nan and +/- inf
v_med3_f32 v6, v[vgprValuC+21], v8, v9
v_cndmask_b32 v[vgprValuC+21], v6, v[vgprValuC+21], s[62:63]
v_cvt_pk_fp8_f32 v21, v[vgprValuC+21], v[vgprValuC+21] op_sel:[0,0,0]
buffer_store_byte v21, v17, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0 // store D
v_cmp_gt_u32 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], s[sgprSrdScaleAlphaVec+2], 0 //  == 0 ?
v_cndmask_b32 v15, 1.0, v15, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
v_mul_f32 v[vgprValuC+26], v15, v[vgprValuC+26]    // *= ScaleAlphaVecVMul
v_cvt_f32_fp8 v4, v25 src0_sel:BYTE_0
s_nop 0
v_fmac_f32 v[vgprValuC+26], v4, s[sgprBeta]        // finalSum = sum*alpha + C*beta
v_add_f32 v[vgprValuC+26], v14, v[vgprValuC+26]    // C += bias
v_max_f32 v[vgprAmaxOut], v[vgprAmaxOut], abs(v[vgprValuC+26]) // absmax
v_mul_f32 v[vgprValuC+26], v[vgprValuC+26], s[sgprScaleD] // result *= ScaleD
v_cmp_class_f32 s[62:63], v[vgprValuC+26], v7      // Nan and +/- inf
v_med3_f32 v6, v[vgprValuC+26], v8, v9
v_cndmask_b32 v[vgprValuC+26], v6, v[vgprValuC+26], s[62:63]
...
v_cmp_gt_u32 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], s[sgprSrdScaleAlphaVec+2], 0 //  == 0 ?
v_cndmask_b32 v15, 1.0, v15, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
v_mul_f32 v[vgprValuC+31], v15, v[vgprValuC+31]    // *= ScaleAlphaVecVMul
v_cvt_f32_fp8 v4, v30 src0_sel:BYTE_0
s_nop 0
v_fmac_f32 v[vgprValuC+31], v4, s[sgprBeta]        // finalSum = sum*alpha + C*beta
v_add_f32 v[vgprValuC+31], v14, v[vgprValuC+31]    // C += bias
v_max_f32 v[vgprAmaxOut], v[vgprAmaxOut], abs(v[vgprValuC+31]) // absmax
v_mul_f32 v[vgprValuC+31], v[vgprValuC+31], s[sgprScaleD] // result *= ScaleD
v_cmp_class_f32 s[62:63], v[vgprValuC+31], v7      // Nan and +/- inf
v_med3_f32 v6, v[vgprValuC+31], v8, v9
v_cndmask_b32 v[vgprValuC+31], v6, v[vgprValuC+31], s[62:63]
v_cvt_pk_fp8_f32 v31, v[vgprValuC+31], v[vgprValuC+31] op_sel:[0,0,0]
buffer_store_byte v31, v27, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0 // store D
s_nop 0                                            // 1 wait state required when next inst writes vgprs held by previous dwordx4 store inst
s_branch label_GW_End_1                            // jump to end
label_GW_End_1:
label_KernelEnd:
...
.set sgprAddrAmaxOut, 80
.set sgprAddressWk, 82
.set sgprAddressSy, 84

s_load_dwordx4 s[sgprAddrAmaxOut:sgprAddrAmaxOut+3], s[sgprKernArgAddress:sgprKernArgAddress+1], 0x90
s_load_dwordx2 s[sgprAddressSy:sgprAddressSy+1], s[sgprKernArgAddress:sgprKernArgAddress+1], 0xa0
s_mul_i32 s[sgprNumGroup], s[sgprNumWorkGroups0], s[sgprNumWorkGroups1] // get total num_wgs
s_mul_i32 s[sgprWGIdx], s[sgprWorkGroup1], s[sgprNumWorkGroups0] // wgId = wg1 * numWG0
s_add_i32 s[sgprWGIdx], s[sgprWGIdx], s[sgprWorkGroup0] // wgId += wg0
...
v_cvt_f32_u32 v[vgprTmp], v[vgprSerial]
...
s_mov_b32 s[sgprDst+2], s[sgprTmp]
...
v_max_f32 v[vgprAmaxOut], v[vgprAmaxOut], abs(v[vgprValue])
...
s_mov_b32 s[sgprDst+0], s[sgprAddrAmaxOut+0]
s_mov_b32 s[sgprDst+1], s[sgprAddrAmaxOut+1]
